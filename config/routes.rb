Brak::Application.routes.draw do
  ...
  devise_for(:users, :path => 'me',
    ...
    get    "me/password/edit" => "devise/registrations#edit_password",        :as => :edit_user_password
    delete "me"               => "devise/registrations#destroy",              :as => :destroy_user_registration
    get    "me/delete"        => "devise/registrations#destroy_step_1", :as => :destroy_user_registration_step_1
